...
flags.DEFINE_integer('image_size', 64, 'the size of picture')
flags.DEFINE_integer('category', 100, 'the kinds of picture')
# for training
...
#   environment setting    #
############################
flags.DEFINE_string('dataset', 'character', 'The name of dataset [mnist, fashion-mnist')
...
#flags.DEFINE_string('image_size', 64, 'path for saving results')
############################
#   distributed setting    #
############################
